        ...
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center justify-center gap-3 mb-4 no-underline">
            ...
            <div>
              ...
              <span className="text-sm text-neutral-500">Secure crop monitoring in minutes</span>
            </div>
          </Link>
          ...
          <p className="text-neutral-600 text-base max-w-xl mx-auto">
            Sign in to continue using AI crop diagnostics for healthier fields and better harvests.
          </p>
        </div>
